        ...
        ManualPanGestureRecognizer: GestureRecognizerFactoryWithHandlers<ManualPanGestureRecognizer>(
          ...
          (ManualPanGestureRecognizer instance) {
            ...
            instance.onDown = (_) {
              ...
              ref.read(windowResizeProvider(widget.viewId).notifier).startPotentialResize();
              ...
              interactiveResizeSubscription = ref.listenManual<ResizeEdgeObject>(
                ...
                ref.read(windowResizeProvider(widget.viewId).notifier).startResize(resizeEdge.edge, size);
            ...
            instance.onUpdate = (DragUpdateDetails event) {
              ...
              ref.read(windowResizeProvider(widget.viewId).notifier).resize(event.delta);
            };
            instance.onEnd = (_) {
              ref.read(windowMoveStateNotifierProvider(widget.viewId).notifier).endMove();
              ref.read(windowResizeProvider(widget.viewId).notifier).endResize();
            ...
            instance.onCancel = () {
              ...
              ref.read(windowResizeProvider(widget.viewId).notifier).cancelResize();
              interactiveMoveSubscription?.close();
              interactiveResizeSubscription?.close();
            };
          },
