...
void send_window_mapped(BinaryMessenger& messenger,
                        size_t view_id, int surface_width, int surface_height, wlr_box& visible_bounds);

void send_popup_mapped(BinaryMessenger& messenger,
                       size_t view_id, size_t parent_view_id, wlr_box& surface_box, wlr_box& visible_bounds);
